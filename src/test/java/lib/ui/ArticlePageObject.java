...
abstract public class ArticlePageObject extends MainPageObject{
    ...
    @Step("Waiting for title on the article page1")
    ...
    @Step("Adding the article my list")
    ...
    @Step("Saved the article to my list, on folder")
    ...
    @Step("Adding the article to saved not information windows ")
    ...
    @Step("Closing the article and clear search line")
    ...
    @Step("Get amount of elements to my list")
